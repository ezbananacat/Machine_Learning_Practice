...
def start_predict_xgboost():
    ...
    X_train_val, X_test, y_train_val, y_test = train_test_split(X, y, test_size=0.2, train_size=0.8, random_state=random_seed)
    ...
    generate_beeswarm_plot(X_train_val, xgb_model)
...
def generate_beeswarm_plot(X_train_val, model):
    ...
    shap.summary_plot(shap_values, X_train_val, plot_type="dot")  # You can also use "dot" or "bar"
